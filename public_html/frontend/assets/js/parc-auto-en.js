...
const CAR_MODELS = {
        'vw-touran-automat': {
            title: 'VW TOURAN AUTOMATIC',
            images: [
                { file: 'vw-touran/veiron-rent-vw-touran-inchirieri-auto.png', alt: 'VW Touran automatic - car rental Satu Mare', isDirectImage: true }
            ]
        },
    ...
    'vw-jetta-manual': {
        ...
        images: [
            { file: 'vw-jetta-2.0/vw-jetta-2-0-diese-satu-mare-ieftin.png', alt: 'VW Jetta 2.0 manual diesel - affordable car rental Satu Mare', isDirectImage: true }
        ]
    },
    'vw-tiguan-automat': {
    ...
    'toyota-avensis-combi': {
        ...
        images: [
            { file: 'toyota-avensis-combi/toyota-avensis-combi-solutionare-daune-auto-satu-mare.png', alt: 'Toyota Avensis Combi - estate car rental Satu Mare', isDirectImage: true }
        ]
    }
};
